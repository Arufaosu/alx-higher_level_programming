...
class TestSquare_instantiation(unittest.TestCase):
    """Unittests instantiation of the Square class"""
...
class TestSquare_size(unittest.TestCase):
    """Unittests size initialization of the Square class"""
...
class TestSquare_x(unittest.TestCase):
    """Unittests initialization of Square x"""
...
class TestSquare_y(unittest.TestCase):
    """Unittests initialization of Square y"""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """Unittests order of Square attribute initialization"""
...
class TestSquare_stdout(unittest.TestCase):
    """Unittests str and display methods of Square class"""

    @staticmethod
    def capture_stdout(sq, method):
        """Capture and returns text

        Args:
            sq: square print to stdout
            method: method to run
        Returns: text printed to stdout by calling method
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
